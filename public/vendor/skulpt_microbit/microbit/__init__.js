const PythonIDE = {
	runAsync: console.log,
	editor: {
		getValue: ()=>"",
	},
	python: {
		output: console.log,
		updateMicrobitPins: console.log,
	},
	showHint: console.log,
	microbit_firmware: "",
}
...
var uart = function (name) {
	...
	var init = function(baudrate, bits, parity, stop, tx, rx) {
		if(baudrate === undefined)
			baudrate = Sk.builtin.assk$(9600);
		if(bits === undefined)
			bits = Sk.builtin.assk$(8);
		if(parity === undefined)
			parity = new Sk.builtin.none;
		if(stop === undefined)
			stop = Sk.builtin.assk$(1);
		if(tx === undefined)
			tx = new Sk.builtin.none;
		if(rx === undefined)
			rx = new Sk.builtin.none;
	}

	init.co_varnames = ['baudrate', 'bits', 'parity', 'stop', 'tx', 'rx'];
	init.$defaults = [Sk.builtin.assk$(9600), Sk.builtin.assk$(8), new Sk.builtin.none, Sk.builtin.assk$(1), new Sk.builtin.none, new Sk.builtin.none];
	init.co_numargs = 6;
...
var i2c = function(name) {
	...
	read.$defaults = [Sk.builtin.none, new Sk.builtin.none, new Sk.builtin.bool(false)];
	read.co_numargs = 3;
	...
	write.$defaults = [Sk.builtin.none, new Sk.builtin.none, new Sk.builtin.bool(false)];
	write.co_numargs = 3;
...
var compass = function(name) {
	...
	mod.get_x = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.x);
	});

	mod.get_y = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.y);
	});

	mod.get_z = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.z);
	});

	mod.heading = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.heading);
	});

	mod.get_field_strength = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.strength);
	});
...
var display = function(name) {
	...
	mod.get_pixel = new Sk.builtin.func(function(x, y) {
		return Sk.builtin.assk$(leds[y.v][x.v]);
	});
	...
	var show = function(image, delay, wait, loop, clear) {
		...
		if(clear === undefined)
			clear = new Sk.builtin.bool(false);

		if(delay === undefined)
			delay = Sk.builtin.assk$(400);
	...
	show.$defaults = [Sk.builtin.none, new Sk.builtin.none, true, true, false];
	show.co_numargs = 5;
	...
	scroll.$defaults = [Sk.builtin.none, Sk.builtin.assk$(400)];
	scroll.co_numargs = 2;
...
var $builtinmodule = function (name) {
	...
	mod.temerature = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(23);
	});

	mod.running_time = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(Date.now() - start_time);
	});
	...
	mod.temperature = new Sk.builtin.func(function() {
		return Sk.builtin.assk$(mod.data.temperature);
	});
	...
	var ioPinDigital = new Sk.misceval.buildClass(mod, function($gbl, $loc) {
		...
		$loc.read_digital = new Sk.builtin.func(function(self){
			return Sk.builtin.assk$(self.value);
		});
	...
	mod.Image = new Sk.misceval.buildClass(mod, function($gbl, $loc) {
		...
		$loc.get_pixel = new Sk.builtin.func(function(self, x, y){
			return Sk.builtin.assk$(self.lines[y.v][x.v]);
		});
	...
	mod.Image.prototype.HEART = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09090:99999:99999:09990:00900:"));
	mod.Image.prototype.HEART_SMALL = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09090:09990:00900:00000:"));
	mod.Image.prototype.HAPPY = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09090:00000:90009:09990:"));
	mod.Image.prototype.SMILE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00000:90009:09990:"));
	mod.Image.prototype.SAD = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09090:00000:09990:90009:"));
	mod.Image.prototype.CONFUSED = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09090:00000:09090:90909:"));
	mod.Image.prototype.ANGRY = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90009:09090:00000:99999:90909:"));
	mod.Image.prototype.ASLEEP = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:99099:00000:09990:00000:"));
	mod.Image.prototype.SURPRISED = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09090:00000:00900:09090:00900:"));
	mod.Image.prototype.SILLY = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90009:00000:99999:00909:00999:"));
	mod.Image.prototype.FABULOUS = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99999:99099:00000:09090:09990:"));
	mod.Image.prototype.MEH = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09090:00000:00090:00900:09000:"));
	mod.Image.prototype.YES = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00009:00090:90900:09000:"));
	mod.Image.prototype.NO = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90009:09090:00900:09090:90009:"));
	mod.Image.prototype.CLOCK12 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00900:00900:00000:00000:"));
	mod.Image.prototype.CLOCK1 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00090:00090:00900:00000:00000:"));
	mod.Image.prototype.CLOCK2 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00099:00900:00000:00000:"));
	mod.Image.prototype.CLOCK3 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00999:00000:00000:"));
	mod.Image.prototype.CLOCK4 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00900:00099:00000:"));
	mod.Image.prototype.CLOCK5 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00900:00090:00090:"));
	mod.Image.prototype.CLOCK6 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00900:00900:00900:"));
	mod.Image.prototype.CLOCK7 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00900:09000:09000:"));
	mod.Image.prototype.CLOCK8 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:00900:99000:00000:"));
	mod.Image.prototype.CLOCK9 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00000:99900:00000:00000:"));
	mod.Image.prototype.CLOCK10 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:99000:00900:00000:00000:"));
	mod.Image.prototype.CLOCK11 = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09000:09000:00900:00000:00000:"));
	mod.Image.prototype.ARROW_N = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09990:90909:00900:00900:"));
	mod.Image.prototype.ARROW_NE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00999:00099:00909:09000:90000:"));
	mod.Image.prototype.ARROW_E = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00090:99999:00090:00900:"));
	mod.Image.prototype.ARROW_SE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90000:09000:00909:00099:00999:"));
	mod.Image.prototype.ARROW_S = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00900:90909:09990:00900:"));
	mod.Image.prototype.ARROW_SW = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00009:00090:90900:99000:99900:"));
	mod.Image.prototype.ARROW_W = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09000:99999:09000:00900:"));
	mod.Image.prototype.ARROW_NW = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99900:99000:90900:00090:00009:"));
	mod.Image.prototype.TRIANGLE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00900:09090:99999:00000:"));
	mod.Image.prototype.TRIANGLE_LEFT = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90000:99000:90900:90090:99999:"));
	mod.Image.prototype.CHESSBOARD = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09090:90909:09090:90909:09090:"));
	mod.Image.prototype.DIAMOND = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09090:90009:09090:00900:"));
	mod.Image.prototype.DIAMOND_SMALL = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:00900:09090:00900:00000:"));
	mod.Image.prototype.SQUARE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99999:90009:90009:90009:99999:"));
	mod.Image.prototype.SQUARE_SMALL = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09990:09090:09990:00000:"));
	mod.Image.prototype.RABBIT = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90900:90900:99990:99090:99990:"));
	mod.Image.prototype.COW = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90009:90009:99999:09990:00900:"));
	mod.Image.prototype.MUSIC_CROTCHET = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00900:00900:99900:99900:"));
	mod.Image.prototype.MUSIC_QUAVER = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00990:00909:99900:99900:"));
	mod.Image.prototype.MUSIC_QUAVERS = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09999:09009:09009:99099:99099:"));
	mod.Image.prototype.PITCHFORK = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("90909:90909:99999:00900:00900:"));
	mod.Image.prototype.XMAS = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09990:00900:09990:99999:"));
	mod.Image.prototype.PACMAN = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09999:99090:99900:99990:09999:"));
	mod.Image.prototype.TARGET = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09990:99099:09990:00900:"));
	mod.Image.prototype.TSHIRT = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99099:99999:09990:09990:09990:"));
	mod.Image.prototype.ROLLERSKATE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00099:00099:99999:99999:09090:"));
	mod.Image.prototype.DUCK = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09900:99900:09999:09990:00000:"));
	mod.Image.prototype.HOUSE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:09990:99999:09990:09090:"));
	mod.Image.prototype.TORTOISE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00000:09990:99999:09090:00000:"));
	mod.Image.prototype.BUTTERFLY = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99099:99999:00900:99999:99099:"));
	mod.Image.prototype.STICKFIGURE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:99999:00900:09090:90009:"));
	mod.Image.prototype.GHOST = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99999:90909:99999:99999:90909:"));
	mod.Image.prototype.SWORD = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("00900:00900:00900:09990:00900:"));
	mod.Image.prototype.GIRAFFE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99000:09000:09000:09990:09090:"));
	mod.Image.prototype.SKULL = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09990:90909:99999:09990:09990:"));
	mod.Image.prototype.UMBRELLA = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("09990:99999:00900:90900:09900:"));
	mod.Image.prototype.SNAKE = Sk.misceval.callsim(mod.Image, new Sk.builtin.str("99000:99099:09090:09990:00000:"));

	mod.Image.prototype.ALL_CLOCKS = new Sk.builtin.list([mod.Image.prototype.CLOCK1, mod.Image.prototype.CLOCK2, mod.Image.prototype.CLOCK3, mod.Image.prototype.CLOCK4, mod.Image.prototype.CLOCK5, mod.Image.prototype.CLOCK6, mod.Image.prototype.CLOCK7, mod.Image.prototype.CLOCK8, mod.Image.prototype.CLOCK9, mod.Image.prototype.CLOCK10, mod.Image.prototype.CLOCK11, mod.Image.prototype.CLOCK12]);
	mod.Image.prototype.ALL_ARROWS = new Sk.builtin.list([mod.Image.prototype.ARROW_N, mod.Image.prototype.ARROW_NE, mod.Image.prototype.ARROW_E, mod.Image.prototype.ARROW_SE, mod.Image.prototype.ARROW_S, mod.Image.prototype.ARROW_SW, mod.Image.prototype.ARROW_W, mod.Image.prototype.ARROW_NW]);
...
Sk.builtinFiles.files["src/lib/microbit/__init__.js"] = `var $builtinmodule = ` + $builtinmodule.toString();